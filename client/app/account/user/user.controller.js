...
angular.module('webBookApp')
  .controller('userController', ['$scope', '$rootScope', '$state', '$http', '$timeout', '$sce', '$log', 'growl', 'UserService', function($scope, $rootScope, $state, $http, $timeout, $sce, $log, growl, UserService) {
